...
public class FourthScene: SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("myimage","fall",get_scene_width(),get_scene_height());
        ...
        text2 = add_sprite_for_text("WINTER", "myfont");
        text2.move(0.9*get_scene_width(),0.8*get_scene_height());
        text3 = add_sprite_for_text("SPRING", "myfont");
        text3.move(0.9*get_scene_width(),0.85*get_scene_height());
        text4 = add_sprite_for_text("SUMMER", "myfont");
